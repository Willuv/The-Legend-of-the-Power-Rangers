...
namespace Legend_of_the_Power_Rangers
{
    public class ItemTriforce : IItem
    {
        ...
        private Microsoft.Xna.Framework.Rectangle rectangle = new Microsoft.Xna.Framework.Rectangle(320, 120, 16, 16);
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (change <= time/2)
            {
                rectangle = new Microsoft.Xna.Framework.Rectangle(320, 120, 16, 16);
                if (change == 1)
                {
                    reverse = false;
                }
            ...
            {
                rectangle = new Microsoft.Xna.Framework.Rectangle(340, 120, 16, 16);
                if (change == time)
                {
                    reverse = true;
                }
